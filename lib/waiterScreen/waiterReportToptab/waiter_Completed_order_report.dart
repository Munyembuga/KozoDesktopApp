...
class WaiterCompletedOrderReport extends StatefulWidget {
  const WaiterCompletedOrderReport({Key? key}) : super(key: key);

  @override
  State<WaiterCompletedOrderReport> createState() =>
      _WaiterCompletedOrderReportState();
}

class _WaiterCompletedOrderReportState
    extends State<WaiterCompletedOrderReport> {
  ...
  Future<void> _fetchCompletedOrders() async {
    ...
    try {
      ...
      final orders = await _waiterReportingService.getCompletedOrders(
      ...
      print("Response Data Completed: $orders");

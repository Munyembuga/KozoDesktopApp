...
class WaiterOrderTabDelivery extends StatefulWidget {
  const WaiterOrderTabDelivery({super.key});

  @override
  State<WaiterOrderTabDelivery> createState() => _WaiterOrderTabDeliveryState();
}

class _WaiterOrderTabDeliveryState extends State<WaiterOrderTabDelivery> {
  ...
  Future<void> _fetchServedOrders() async {
    try {
      ...
      final orders = await WaiterOrderServices.fetchServedOrders(

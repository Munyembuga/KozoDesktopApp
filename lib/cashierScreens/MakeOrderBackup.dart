...
import 'package:kozo/cashierScreens/widgets/cart_widget.dart';
          ...
          if (spec.id != 0) {
            ...
            if (discount != null) {
              ...
              _cartItems[i] = CartItem(
                ...
                accompanimentsIds: cartItem.accompanimentsIds,
  ...
  Future<void> _toggleItemSpecifications(MenuItem item) async {
    ...
    try {
      final specificationsResponse =
          await OrderService.fetchSpecifications(item.id);
        ...
        children: [
          ...
          Expanded(
            ...
            child: Scrollbar(
              ...
              thickness: 20.0, // Increased thickness for better appearance
                      ...
                      Container(
                        ...
                        child: _categories.isEmpty
                            ...
                            : Scrollbar(
                                ...
                                thumbVisibility: true,
                                thickness:
                                    20.0, // Thicker scrollbar for categories
                                radius: const Radius.circular(10),
                                trackVisibility: true,
          ...
          Expanded(
            ...
            child: Scrollbar(
              ...
              thumbVisibility: true,
              thickness:
                  50.0, // Slightly thicker to differentiate from left scrollbar
                ...
                child: SizedBox(
                  ...
                  child: CartWidget(
                      ...
                      setState(() {
                        ...
                        if (index >= 0) {
                          _cartItems[index] = CartItem(
                            ...
                            accompanimentsIds:
                                _cartItems[index].accompanimentsIds,
                    ...
                    onUpdateItemPrepOrder:
                        (itemId, specificationId, prepOrder) {
                      // Stub for backup file
                    },
                    onUpdateItemPressure:
                        (itemId, specificationId, pressureId) {
                      // Stub for backup file
                    },

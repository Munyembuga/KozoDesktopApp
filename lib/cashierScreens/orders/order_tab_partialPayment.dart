...
class OrderTabPartialPayment extends StatefulWidget {
  const OrderTabPartialPayment({super.key});

  @override
  State<OrderTabPartialPayment> createState() => _OrderTabPartialPaymentState();
}

class _OrderTabPartialPaymentState extends State<OrderTabPartialPayment> {
  ...
  Future<void> _fetchPartialPaymentOrders() async {
    try {
      ...
      final orders = await OrderService.fetchPartialPaymentOrders(

...
class BarItemSelection extends StatefulWidget {
  ...
  @override
  State<BarItemSelection> createState() => _BarItemSelectionState();
}

class _BarItemSelectionState extends State<BarItemSelection> {

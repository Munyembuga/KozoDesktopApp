...
import '../cashierScreens/makeNewOrder.dart';
import '../cashierScreens/order_screen.dart';
import '../cashierScreens/dashboard_screen.dart';
import '../cashierScreens/login_screen.dart';
import '../constants/app_constants.dart';
import '../services/auth_service.dart';
import '../cashierScreens/report_screen.dart'; // Add this import

class NavRailMainCashier extends StatefulWidget {
  final int initialIndex;

  const NavRailMainCashier({super.key, this.initialIndex = 0});

  @override
  State<NavRailMainCashier> createState() => _NavRailMainCashierState();
}

class _NavRailMainCashierState extends State<NavRailMainCashier> {
  ...
  final List<Widget> _screens = [
    ...
    const OrderScreen(),
    const ReportScreen(), // Add the Report Screen
